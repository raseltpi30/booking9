        ...
        <div class="steps-container">
            <div class="step">
                <div class="content-wrapper">
                    <img src="https://static1.squarespace.com/static/6682192d1022a0098a1c29d9/t/66b36bfa9a721873928705e8/1723034623407/Schedule+Now%21.jpg" alt="Schedule Image" loading="lazy">
                    <h3>Book</h3>
            ...
            <div class="step">
                <div class="content-wrapper">
                    <img src="https://static1.squarespace.com/static/6682192d1022a0098a1c29d9/t/66ba17fc07413900af42007c/1723471879967/People+Cleaning.jpg" alt="Clean Image" loading="lazy">
                    <h3>Clean</h3>
            ...
            <div class="step">
                <div class="content-wrapper">
                    <img src="https://static1.squarespace.com/static/6682192d1022a0098a1c29d9/t/66ba17fedf474271756d1450/1723471884045/Relax.jpg" alt="Relax Image" loading="lazy">
                    <h3>Relax</h3>
            ...
            <div class="features">
                <div class="feature-item">
                    <div class="feature-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-star">
                ...
                <div class="feature-item">
                    <div class="feature-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shield">
                            <path d="M12 22c4.97-1.64 8-6.18 8-11V5.34c0-.6-.26-1.17-.71-1.58L12 .3 4.71 3.76c-.45.41-.71.98-.71 1.58V11c0 4.82 3.03 9.36 8 11z">
                            </path>
                        </svg>
                    </div>
                ...
                <div class="feature-item">
                    <div class="feature-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clock">
                ...
                <div class="feature-item">
                    <div class="feature-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
...
<section class="testimonial-area">
    ...
    <div class="review-container">
        ...
        <div class="review-card">
            ...
            <div class="rating">
                <span class="stars">
                    @for ($i = 1; $i <= 5; $i++) @if($i <=$review['rating']) <i class="fa-solid fa-star"></i> @else <i class="fa-regular fa-star"></i> @endif @endfor
                </span>
            ...
            <div class="review-text">
                <span class="trimmed-text">
                    {{ $trimmedText }}@if(str_word_count($fullText) > 40) ... @endif
                </span>
        ...
        <div class="review-card">
            ...
            <div class="review-text">Have used their service twice. Both for move in / move out cleans. Once for an entire
