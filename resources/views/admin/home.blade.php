            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0"
                        ...
                        <a class="dropdown-item preview-item">
                            <div class="preview-thumbnail">
                                <img src="{{asset('backend')}}/assets/images/faces/face12.jpg" alt="image"
                                    class="img-sm profile-pic">
                            </div>
                            <div class="preview-item-content flex-grow py-2">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="mt-3">
                                                                        <div
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <img class="img-sm rounded-10"
                                                                                    src="{{asset('backend')}}/assets/images/faces/face1.jpg"
                                                                                    alt="profile">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <img class="img-sm rounded-10"
                                                                                    src="{{asset('backend')}}/assets/images/faces/face2.jpg"
                                                                                    alt="profile">
                                                                                <div class="wrapper ms-3">
                                                                                    <p class="ms-1 mb-1 fw-bold">
                                                                                        Wayne Murphy</p>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <img class="img-sm rounded-10"
                                                                                    src="{{asset('backend')}}/assets/images/faces/face3.jpg"
                                                                                    alt="profile">
                                                                                <div class="wrapper ms-3">
                                                                                    <p class="ms-1 mb-1 fw-bold">
                                                                                        Katherine Butler</p>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <img class="img-sm rounded-10"
                                                                                    src="{{asset('backend')}}/assets/images/faces/face4.jpg"
                                                                                    alt="profile">
                                                                                <div class="wrapper ms-3">
                                                                                    <p class="ms-1 mb-1 fw-bold">
                                                                                        Matthew Bailey</p>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <img class="img-sm rounded-10"
                                                                                    src="{{asset('backend')}}/assets/images/faces/face5.jpg"
                                                                                    alt="profile">
                                                                                <div class="wrapper ms-3">
                                                                                    <p class="ms-1 mb-1 fw-bold">
                                                                                        Rafell John</p>
